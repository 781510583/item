...
// import { departmentAPI } from "@/api/hospital";
...
// import {hospitaldetailAPI} from '@/api/hospital'
import { onMounted } from 'vue';
// const department = async () => {
//   const res: any = await departmentAPI('1000_0');
//   console.log(res);
// };
onMounted(() => {
  // department()
  detailStore.getHospital($route.query.hoscode)
  detailStore.hosdepartment($route.query.hoscode)
})
</script>
